...
<div class="container">
    ...
    <form action="{{ route('kandidat.update',$kandidat->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="input-group justify-content-center">
            <input type="text" class="form-control col-6 mb-3" placeholder="Nama Pasangan" name="nama_pasangan" value="{{$kandidat->nama_pasangan}}">
        </div>
        @if($errors->has('nama_pasangan'))
        <small class="text-danger mx-auto">{{$errors->first('nama_pasangan')}}</small>
        @endif
        <div class="input-group justify-content-center">
            <input type="file" class="form-control col-6 mb-3" placeholder="Foto Kandidat" name="photo" value="{{$kandidat->photo}}">
        </div>
        @if($errors->has('photo'))
        <small class="text-danger mx-auto">{{$errors->first('photo')}}</small>
        @endif
        <div class="input-group justify-content-center">
            <select type="text" name="pemilihan_id" class="form-control col-6 mb-3" required id="pemilihan_id" value="{{$kandidat->pemilihan_id}}">
                <option>Pilih</option>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="NIS_ketua" value="{{$kandidat->NIS_ketua}}">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="nama_ketua" value="{{$kandidat->nama_ketua}}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="kelas_ketua" value="{{$kandidat->kelas_ketua}}">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select name="jurusan_ketua" class="form-control" value="{{$kandidat->jurusan_ketua}}">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="NIS_wakil" value="{{$kandidat->NIS_wakil}}">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" name="nama_wakil" value="{{$kandidat->nama_wakil}}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="kelas_wakil" value="{{$kandidat->kelas_wakil}}">
                    ...
                    <div class="form-group mb-2">
                        <label for="">Jurusan</label>
                        <select name="jurusan_wakil" class="form-control" value="{{$kandidat->jurusan_wakil}}">
                            <option value="IPA">IPA</option>
                            <option value="IPS">IPS</option>
                            <option value="Bahasa">Bahasa</option>
                        </select>
        ...
        <div class="card col-lg">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea name="visi" class="form-control" cols="30" rows="5" value="{{$kandidat->visi}}">{{old('visi')}}</textarea>
                    @if($errors->has('visi'))
                ...
                <div class="form-group">
                    ...
                    <textarea name="misi" class="form-control" cols="30" rows="5" value="{{$kandidat->misi}}">{{old('misi')}}</textarea>
                    @if($errors->has('misi'))
                ...
                <div class="form-group">
                    ...
                    <textarea name="program_kerja" class="form-control" cols="30" rows="5" value="{{$kandidat->program_kerja}}">{{old('program_kerja')}}</textarea>
